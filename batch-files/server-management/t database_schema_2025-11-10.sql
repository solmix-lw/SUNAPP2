...
-- Generated: 11/10/2025, 12:25:06 PM
-- Database: PostgreSQL
...
-- Table: work_order_labor_entries
CREATE TABLE IF NOT EXISTS "work_order_labor_entries" (
  "id" character varying NOT NULL DEFAULT gen_random_uuid(),
  "work_order_id" character varying NOT NULL,
  "employee_id" character varying NOT NULL,
  "entry_type" text NOT NULL DEFAULT 'actual'::text,
  "time_source" text NOT NULL DEFAULT 'manual'::text,
  "hours_worked" numeric NOT NULL,
  "hourly_rate_snapshot" numeric NOT NULL,
  "overtime_factor" numeric DEFAULT 1.00,
  "total_cost" numeric NOT NULL,
  "description" text,
  "work_date" timestamp without time zone,
  "entered_by_id" character varying,
  "created_at" timestamp without time zone NOT NULL DEFAULT now()
);

-- Table: work_order_lubricant_entries
CREATE TABLE IF NOT EXISTS "work_order_lubricant_entries" (
  "id" character varying NOT NULL DEFAULT gen_random_uuid(),
  "work_order_id" character varying NOT NULL,
  "entry_type" text NOT NULL DEFAULT 'actual'::text,
  "spare_part_id" character varying,
  ...
  "item_number" text,
  "category" text DEFAULT 'lubricant'::text,
...
-- Table: work_order_outsource_entries
CREATE TABLE IF NOT EXISTS "work_order_outsource_entries" (
  "id" character varying NOT NULL DEFAULT gen_random_uuid(),
  "work_order_id" character varying NOT NULL,
  "entry_type" text NOT NULL DEFAULT 'actual'::text,
...
CREATE TABLE IF NOT EXISTS "work_orders" (
  ...
  "planned_lubricant_cost" numeric,
  "planned_outsource_cost" numeric,
  "total_planned_cost" numeric,
  "actual_labor_cost" numeric,
  "actual_lubricant_cost" numeric,
  "actual_outsource_cost" numeric,
...
-- UNIQUE constraint on employee_performance_snapshots(employee_id)
...
-- PRIMARY KEY on equipment_parts_compatibility(equipment_id)
...
-- UNIQUE constraint on work_order_approvals(work_order_id)
...
-- FOREIGN KEY: work_order_labor_entries(employee_id) → employees(id)
-- FOREIGN KEY: work_order_labor_entries(entered_by_id) → employees(id)
-- FOREIGN KEY: work_order_labor_entries(work_order_id) → work_orders(id)
-- PRIMARY KEY on work_order_labor_entries(id)
-- FOREIGN KEY: work_order_lubricant_entries(entered_by_id) → employees(id)
-- FOREIGN KEY: work_order_lubricant_entries(work_order_id) → work_orders(id)
-- FOREIGN KEY: work_order_lubricant_entries(spare_part_id) → spare_parts(id)
-- PRIMARY KEY on work_order_lubricant_entries(id)
...
-- FOREIGN KEY: work_order_outsource_entries(work_order_id) → work_orders(id)
-- FOREIGN KEY: work_order_outsource_entries(entered_by_id) → employees(id)
-- PRIMARY KEY on work_order_outsource_entries(id)
